...
public class HerokuAPI {
    ...
    public static String authenticate(String changedAPIKey) throws IOException, BaseURLNotAssignedException,
	    APIKeyNotAssignedException {
	apiKey = changedAPIKey;
	return authenticate();
    }

    public static String authenticate() throws IOException, BaseURLNotAssignedException, APIKeyNotAssignedException {
    ...
    public static String authenticate(Map<String, String> param) throws IOException, BaseURLNotAssignedException,
	    APIKeyNotAssignedException {
    ...
    public static String invokeAccount() throws BaseURLNotAssignedException, APIKeyNotAssignedException, IOException {
